...
use crate::model::{core::{Error, Reference}, database::{entity::EntityID, Database}, storable::Storable};
...
impl Equation
{
    pub fn from_str(s: &str, equation_name: &str, container: EntityID) -> Equation
    {
    ...
    //     EquationCompute
    //     {
    //         equation_ref: self.to_ref(),
    //     }
    // }

    fn ast_compute<D: Database>(&self, db: &D) -> Result<Value, Error>
    {
...
{
    equation_ref: Reference,
    // TODO: Inputs requests
}
