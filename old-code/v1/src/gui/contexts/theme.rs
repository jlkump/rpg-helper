...
pub struct Theme {
    ...
    pub h5: String,
    pub h6: String,
    pub header_collapse_arrow: String,
    pub header_collapse_arrow_hover: String,
    ...
    pub border_popup: String,
    pub border_image: String,
    pub dropshadow: String,
...
fn get_default_theme() -> Theme {
    Theme {
        ...
        h5: "#393636".to_owned(),
        h6: "#c79a5a".to_owned(),
        header_collapse_arrow: "#949fb3".to_owned(),
        header_collapse_arrow_hover: "#636e83".to_owned(),
        ...
        border_light: "#8a715f".to_owned(),
        border_hard: "#574037".to_owned(),
        border_tooltip_light: "#bd9f89".to_owned(),
        border_tooltip_hard: "#7a0002".to_owned(),
        border_popup: "#bd9f89".to_owned(),
        border_image: "#bd9f89".to_owned(),
        dropshadow: "rgb(163, 122, 93, 0.5)".to_owned(),
        highlight: "rgba(218, 152, 64, 0.5)".to_owned(),
